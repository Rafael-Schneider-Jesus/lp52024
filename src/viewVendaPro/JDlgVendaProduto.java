...
public class JDlgVendaProduto extends javax.swing.JDialog {
 ...
 super(parent, modal);
        ...
        for (int i = 0; i < lista.size(); i++) {
            jCboProduto.addItem((ProdutoRsj) lista.get(i));
        }
    }
    ...
    private void initComponents() {
        ...
        jCboProduto = new javax.swing.JComboBox<ProdutoRsj>();
    ...
    private void jCboProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCboProdutoActionPerformed
        // TODO add your handling code here:
        ProdutoRsj ProdutoRsj = (ProdutoRsj) jCboProduto.getSelectedItem();
        String cad = String.valueOf(ProdutoRsj.getPrecoRsj());
    ...
    private javax.swing.JComboBox<ProdutoRsj> jCboProduto;
